...
typedef union
{
    ...
    void *contentType;
    WE_UINT32 date;
    WE_UINT8 deliveryReport;
    void *deliveryTime; 
    void *expiry; 
    void *from;
    void *messageClass;
    char *messageId;
    WE_UINT32 messageSize;
    WE_UINT8 messageType; 
    void *previouslySentBy;
    void *previouslySentDate;
    WE_UINT8 priority;
    WE_UINT8 readReply;
    WE_UINT8 readStatus;
    WE_UINT8 replyCharging;
    void *replyChargingDeadline;
    char *replyChargingId;
    WE_UINT32 replyChargingSize;
    WE_UINT8 reportAllowed; 
    WE_UINT8 responseStatus;
    void *responseText;
    WE_UINT8 retrieveStatus;
    void *retrieveText;
    WE_UINT8 senderVisibility;
    WE_UINT8 status;
    void *subject;  
    void *to; 
    char *transactionId;
...
void *cnvTextValueToRFC2616String( void *from, WE_UINT8 modId,
