 ...
 * MMS application is running (MSA).
 ...
 * \param msgId             The message WID of the message received
 ...
 * \param numOfUnreadDR     Number of unread delivery reports
*****************************************************************************/
void MMSa_messageStatus(WE_UINT32 numOfMsg,   WE_UINT32 numOfUnreadMsg,
                        WE_UINT32 numOfNotif, WE_UINT32 numOfUnreadNotif,
                        WE_UINT32 numOfRR,    WE_UINT32 numOfUnreadRR,
                        WE_UINT32 numOfDR,    WE_UINT32 numOfUnreadDR); 
 ...
 * MMS_RESULT_INSUFFICIENT_PERSISTENT_STORAGE, when max number of messages has 
 ...
 *
 *****************************************************************************/
WE_BOOL MMSa_getRoamingStatus(void); 
