 ...
 * amp (&), apos ('), gt (>), lt (<), quot (").
 */ 
extern const we_strtable_info_t we_prsr_XmlEntities;
...
#define WE_PRSR_ERROR_UNKNOWN_CHARSET       1

/* The content contains a syntax error or violates another rule
 * in a basic content specification, such as WBXML or XML. */
#define WE_PRSR_ERROR_SYNTAX                2

/* A document type was could not be determined or the specified
 * type is not supported. */
#define WE_PRSR_ERROR_UNKNOWN_DOCTYPE       3

/* The document uses an unsupported version of WBXML. */
#define WE_PRSR_ERROR_UNSUPPORTED_WBXML     4

/* Unexpected end of document. */
#define WE_PRSR_ERROR_UNEXPECTED_END_OF_DOC 5

/* The application has aborted the parsing. */
#define WE_PRSR_ERROR_APPLICATION           6

/* The parser or one of its resources is not initialized or
 * not available. */
#define WE_PRSR_ERROR_ABORTED               7

/* Parsing aborted. Out of memory. */
#define WE_PRSR_ERROR_OUT_OF_MEMORY         8

/* Document done. */
#define WE_PRSR_STATUS_PARSING_COMPLETED    9

/* Scheduled pause; more to do. Call again. */
#define WE_PRSR_STATUS_MORE_TO_DO           10

/* Unscheduled pause; waiting for more input.
 *
 * If reading from a pipe, then WE_PIPE_POLL has been called
 * and the user will receive a WE_PIPE_SIG_NOTIFY signal when
 * it is time to call again.
 *
 * If reading from a file, then WE_FILE_SELECT has been called
 * and the user wíll receive a WE_FILE_SIG_NOTIFY signal when
 * it is time to call again.
 */
#define WE_PRSR_STATUS_WAIT                 11
 ...
 * element handler.
 */
#define WE_PRSR_UNKNOWN_ELEMENT           -1


/* Tells the type of an attribute value */
#define WE_PRSR_ATTRVAL_INT                1
#define WE_PRSR_ATTRVAL_STR                0


/* Application return codes */
#define WE_PRSR_APPLICATION_OK             0 /* All went well                    */
#define WE_PRSR_APPLICATION_ERROR          1 /* Error; stop parsing document     */
#define WE_PRSR_APPLICATION_OUT_OF_MEMORY  2 /* Out of memory; terminate parsing */


/* Text handling flags */           
#define WE_PRSR_TEXT                       0x01 /* Data is PCDATA */
#define WE_PRSR_CANCELSPACE_S              0x02 /* Cancel space after start tag */
#define WE_PRSR_CANCELSPACE_E              0x04 /* Cancel space after end tag */
#define WE_PRSR_PRE                        0x08 /* Element has xml:space = preserve property */
#define WE_PRSR_VISUAL                     0x10 /* Visual element. Stops space cancelling. */
#define WE_PRSR_OPAQUE                     0x20 /* All char data is preserved including CR LF */

#define WE_PRSR_CANCELSPACE                0x06 /* Cancel space after start and end tag */


/* Constants used in WBXML decoder tables */
#define WE_PRSR_NOT_USED                   0xFF
#define WE_PRSR_DEC_DATA                   0x80


/* Type of input */
#define WE_PRSR_PIPE                       0
#define WE_PRSR_FILE                       1
#define WE_PRSR_BUFFER                     2
 ...
 *
 * WE_PRSR_TYPE_CDATA is pure text. Leading and training
 * white-space are removed. Multiple blanks between words are
 * compacted into a single space.
 *
 *     Example: CDATA
 *     --------
 *     "  text  TEXT  " -->  "text TEXT"
 *
 *
 * WE_PRSR_TYPE_PRCNT and WE_PRSR_TYPE_NUM both takes a positive
 * integer, but WE_PRSR_TYPE_PRCNT also accepts a positiv
 ...
 * 
 *
 * WE_PRSR_TYPE_FLAG takes a boolean attribute, i.e. an attribute
 ...
 * combined.
 *
 * The lookup is case sensitive, if WE_PRSR_TYPE_NO_CASE is not
 * set. See below.
 *
 *     Example: ENUM
 *     --------
 ...
 *
 *
 * WE_PRSR_TYPE_NO_CASE can be combined with any other type and
...
#define WE_PRSR_TYPE_CDATA     0
#define WE_PRSR_TYPE_PRCNT     1
#define WE_PRSR_TYPE_NUM       2
#define WE_PRSR_TYPE_FLAG      3
#define WE_PRSR_TYPE_ENTITY    WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_ENTITIES  WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_ID        WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_IDREF     WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_IDREFS    WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_NMTOKEN   WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_NMTOKENS  WE_PRSR_TYPE_CDATA
#define WE_PRSR_TYPE_NOTATION  WE_PRSR_TYPE_CDATA

#define WE_PRSR_TYPE_NO_CASE   0x8000

#define WE_PRSR_TYPE_ENUM_0    0x0040
#define WE_PRSR_TYPE_ENUM_1    0x0080
#define WE_PRSR_TYPE_ENUM_2    0x0100
#define WE_PRSR_TYPE_ENUM_3    0x0200
#define WE_PRSR_TYPE_ENUM_4    0x0400
#define WE_PRSR_TYPE_ENUM_5    0x0800
#define WE_PRSR_TYPE_ENUM_6    0x1000
#define WE_PRSR_TYPE_ENUM_7    0x2000
#define WE_PRSR_TYPE_ENUM_8    0x4000

#define WE_PRSR_TYPE_ENUM_A    0x000A
#define WE_PRSR_TYPE_ENUM_B    0x000B
#define WE_PRSR_TYPE_ENUM_C    0x000C
#define WE_PRSR_TYPE_ENUM_D    0x000D
#define WE_PRSR_TYPE_ENUM_E    0x000E
#define WE_PRSR_TYPE_ENUM_F    0x000F
#define WE_PRSR_TYPE_ENUM_10   0x0010
#define WE_PRSR_TYPE_ENUM_11   0x0011
#define WE_PRSR_TYPE_ENUM_12   0x0012
#define WE_PRSR_TYPE_ENUM_13   0x0013
#define WE_PRSR_TYPE_ENUM_14   0x0014
#define WE_PRSR_TYPE_ENUM_15   0x0015
#define WE_PRSR_TYPE_ENUM_16   0x0016
#define WE_PRSR_TYPE_ENUM_17   0x0017
#define WE_PRSR_TYPE_ENUM_18   0x0018
#define WE_PRSR_TYPE_ENUM_19   0x0019
#define WE_PRSR_TYPE_ENUM_1A   0x001A
#define WE_PRSR_TYPE_ENUM_1B   0x001B
#define WE_PRSR_TYPE_ENUM_1C   0x001C
#define WE_PRSR_TYPE_ENUM_1D   0x001D
#define WE_PRSR_TYPE_ENUM_1E   0x001E
#define WE_PRSR_TYPE_ENUM_1F   0x001F
#define WE_PRSR_TYPE_ENUM_20   0x8020
#define WE_PRSR_TYPE_ENUM_21   0x0021
#define WE_PRSR_TYPE_ENUM_22   0x0022
#define WE_PRSR_TYPE_ENUM_23   0x0023
#define WE_PRSR_TYPE_ENUM_24   0x0024
#define WE_PRSR_TYPE_ENUM_25   0x0025
#define WE_PRSR_TYPE_ENUM_26   0x0026
#define WE_PRSR_TYPE_ENUM_27   0x0027
#define WE_PRSR_TYPE_ENUM_28   0x0028
#define WE_PRSR_TYPE_ENUM_29   0x0029
#define WE_PRSR_TYPE_ENUM_2A   0x002A
#define WE_PRSR_TYPE_ENUM_2B   0x002B
#define WE_PRSR_TYPE_ENUM_2C   0x002C
#define WE_PRSR_TYPE_ENUM_2D   0x002D
#define WE_PRSR_TYPE_ENUM_2E   0x002E
#define WE_PRSR_TYPE_ENUM_2F   0x002F
#define WE_PRSR_TYPE_ENUM_30   0x0030
#define WE_PRSR_TYPE_ENUM_31   0x0031
#define WE_PRSR_TYPE_ENUM_32   0x0032
#define WE_PRSR_TYPE_ENUM_33   0x0033
#define WE_PRSR_TYPE_ENUM_34   0x0034
#define WE_PRSR_TYPE_ENUM_35   0x0035
#define WE_PRSR_TYPE_ENUM_36   0x0036
#define WE_PRSR_TYPE_ENUM_37   0x0037
#define WE_PRSR_TYPE_ENUM_38   0x0038
#define WE_PRSR_TYPE_ENUM_39   0x0039
#define WE_PRSR_TYPE_ENUM_3A   0x003A
#define WE_PRSR_TYPE_ENUM_3B   0x003B
#define WE_PRSR_TYPE_ENUM_3C   0x003C
#define WE_PRSR_TYPE_ENUM_3D   0x003D
#define WE_PRSR_TYPE_ENUM_3E   0x003E
#define WE_PRSR_TYPE_ENUM_3F   0x003F
...
/*
 * Attributes are given as an array of we_prsr_attribute_t.
 *
 * type - attribute type as defined in table.
 * flag - WE_PRSR_ATTRVAL_INT or WE_PRSR_ATTRVAL_STR.
...
typedef struct we_prsr_attribute_st
{
  short                  type;
  short                  flag;
 ...
 */
typedef struct we_prsr_parser_st       we_prsr_parser_t;
typedef struct we_prsr_parserData_st   we_prsr_parserData_t;
typedef struct we_prsr_decoderData_st  we_prsr_decoderData_t;
 ...
 * is done.
 *
 * Return an application return code (WE_PRSR_APPLICATION_*).
 */
typedef int
we_prsr_init_t (we_prsr_parserData_t*  p,
 ...
 * WE_PRSR_UNKNOWN_ELEMENT.
 */
typedef int
we_prsr_startElementHandler_t (void*                 userData,
                                int                   type,
                                we_prsr_attribute_t* attrs, /* Not used if 'numAttrs' == 0 */
                                int                   numAttrs);

typedef int
we_prsr_endElementHandler_t (void* userData);

typedef int
we_prsr_characterDataHandler_t (void*       userData,
                                 const char* s,
                                 int         len,
                                 int         mode);
 ...
 */
typedef int
we_prsr_piHandler_t (void*              userData,
 ...
 */
typedef int
we_prsr_specificFunct_t (we_prsr_parser_t*  parser,
                          const char*        *s,
                          const char*         end,
 ...
 */
typedef void we_prsr_changeCharset_t (void* userData, we_charset_convert_t* cvtFunct);


/* 
 * Parser document specific configuration. Structure is
 * initiated by a we_prsr_init_t function.
 */
struct we_prsr_parserData_st {
  ...
  we_prsr_startElementHandler_t*  startHandler; /* Called for start and empty tags */
  we_prsr_endElementHandler_t*    endHandler;   /* Called for end and empty tags */
  we_prsr_characterDataHandler_t* charHandler;  /* Called for all non-element and non-pi data */

  const we_strtable_info_t*  elements;       /* Known elements */
  const we_strtable_info_t*  attributes;     /* Known attributes */
  const we_strtable_info_t*  attrvals;       /* Known attribute values */
  const we_strtable_info_t*  entities;       /* Known entities (&amp; &apos;...) */
  const WE_UINT8*            elementTable;   /* Element specific information */
  const WE_UINT16*           attributeType;  /* Type of each attribute */
};
 ...
 * initiated by a we_prsr_init_t function.
 */
struct we_prsr_decoderData_st {
  const WE_UINT8*            transform;      /* AttrStart to attribut table */
  int                         transformSize;  /* Size of transform table */
  const we_strtable_info_t*  attrStart;      /* Attribute values associated with attrStart */
  const we_strtable_info_t*  attrValue;      /* Attribute values associated with attrValue */ 

  we_prsr_specificFunct_t*   specific;       /* Extention and opaque handler. Point to
                                               * we_dec_opaqueSpecific if WBXML opaque data
 ...
 */
void
we_prsr_free_attributes (WE_UINT8             modId,
