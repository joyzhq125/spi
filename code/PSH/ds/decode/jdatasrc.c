...
typedef struct {
  ...
  JOCTET * src_buff;		/* source stream */
  unsigned int src_buff_size;   /* size of source data*/
...
fill_input_buffer (j_decompress_ptr cinfo)
{
  ...
  src->pub.next_input_byte = src->src_buff;
  src->pub.bytes_in_buffer = src->src_buff_size;
...
GLOBAL(void)
jpeg_stdio_src (j_decompress_ptr cinfo, unsigned char * src_buff ,unsigned int src_buff_size)
{
  my_src_ptr src;
  ...
  src->src_buff = src_buff;
  src->src_buff_size = src_buff_size;
