...
====================================================================================================
    ...
    06/05/2004   penghaibo        p005951       add fatal error handle
...
error_exit (j_common_ptr cinfo)
{
  ...
  jpeg_destroy(cinfo);
  /*use longjmp jump to start of decode and return error code*/ 
  op_debug(DEBUG_HIGH,"JPG--fatal error,return to caller use longjmp\n");
  longjmp(cinfo->err->mark,cinfo->err->msg_code);
}
