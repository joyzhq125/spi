 ...
 * We_Chrs.h
 *
 * Created by Anders Edenwbandt, Mon May 14 14:47:28 2001.
 *
 *
 * Revision history:
...
#define WE_CHARSET_UNKNOWN       0
#define WE_CHARSET_ASCII         3
#define WE_CHARSET_ISO_8859_1    4
#define WE_CHARSET_LATIN_1       4
#define WE_CHARSET_UCS_2         1000
#define WE_CHARSET_UTF_16BE      1013
#define WE_CHARSET_UTF_16LE      1014
#define WE_CHARSET_UTF_16        1015
#define WE_CHARSET_UTF_8         106
 ...
 */
typedef int
we_charset_convert_t (const char *src, /* The source buffer. */
 ...
 */
extern const WE_UINT32 we_charset_offsets_from_utf8[5];

/*
 * Number of bytes per UTF-8 character. To be indexed with the
 * first 4 bits of an UTF-8 character.
 */
extern const unsigned char we_charset_utf8_bytes_per_character[16];
...
int 
we_charset_utf8_to_utf8 (const char *src, long *src_len, char *dst, long *dst_len);
