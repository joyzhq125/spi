...
{             
    ...
    M_SEC_DP_MSG_GET_TLS_CLIENT_CERT,
    M_SEC_DP_MSG_VERIFY_TLS_CERT_CHAIN,
    M_SEC_DP_MSG_COMPUTE_TLS_SIGN,
...
typedef enum tagE_SecDpFncId
{
    ...
    E_SEC_DP_GET_TLS_CLIENT_CERT,
    E_SEC_DP_VERIFY_TLS_CERT_CHAIN,
    E_SEC_DP_COMPUTE_TLS_SIGN,
...
/*defined structure for tls*/
typedef struct tagSt_SecDpGetTlsClientCert
{
    E_SecDpFncId                            eType;
    WE_HANDLE hItype;
    St_SecDpParameter*                      pstPrev;
    St_SecDpParameter*                      pstNext;
    St_SecTlsGetUsrCert*                   pstStrct;
}St_SecDpGetTlsClientCert;
