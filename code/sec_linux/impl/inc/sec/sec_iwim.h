...
void Sec_iWimCalSign(WE_HANDLE hSecHandle, WE_INT32 iTargetID, const WE_UCHAR *pucKeyId,
...
void Sec_iWimGetChainOfCertificates(WE_HANDLE hSecHandle,\
                                   WE_UINT8 ucChainDepth, WE_UINT32 *puiCertChainIds);
