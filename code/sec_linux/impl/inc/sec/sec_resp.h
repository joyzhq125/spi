...
#ifdef M_SEC_CFG_TLS
void Sec_TlsGetUsrCertResp(WE_HANDLE hSecHandle, WE_INT32 iTargetID, 
                           WE_INT32 iResult,
...
void Sec_SSLGetMasterSecretResp(WE_HANDLE hSecHandle, WE_INT32 iTargetID, 
                                WE_INT32 iResult, WE_UCHAR *pucMasterSecret);
